        ...
        <Container>
          <Wrapper>
            <TextWrapper isVisible={!isOpen}>
              ...
              <HeroTextSecondary>
                Step into the realm of humanity, where innovation and
                adaptability have crowned us as Earth&apos;s ultimate predator,
                shaping landscapes and rewriting the rules of survival.
              </HeroTextSecondary>
              <RaitingWrapper>
                <RaitingWrapperBtn>
                ...
                <RaitingList isVisible={isOpen}>
                  <RaitingListItem>
                    Humans kill over 1 million animals daily for food. Humans
                    kill animals for their skin, meat, and as experimental
                    subjects in science.
                  </RaitingListItem>
                  <RaitingListItem>
                  ...
                  <RaitingListItem>
                    Humans have successfully adapted to various environments,
                    from icy tundras to scorching deserts.
                  </RaitingListItem>
                  <RaitingListItem>
