      ...
      <SnakeWrapper>
        <Container>
          <TextWrapper>
            ...
            <HeroTextSecondary>
              Slither into the enigmatic world of snakes, where limbless wonders
              navigate silently, employing lethal tactics and serving as
            ...
            <RaitingWrapper>
              ...
              <RaitingList isVisible={isOpen}>
                <RaitingListItem>
                  Snakes lack limbs but are incredibly agile, using their bodies
                ...
                <RaitingListItem>
                  The iconic cobra hood is formed by elongated ribs and a web of
                  skin, creating an intimidating display.
                </RaitingListItem>
                <RaitingListItem>
                ...
                <RaitingListItem>
                  Despite their often-misunderstood reputation, most snakes are
                  harmless to humans, and snakebites are relatively rare.
                </RaitingListItem>
                <RaitingListItem>
                ...
                <RaitingListItem>
                  Snakes shed their skin regularly, a process known as ecdysis,
                  allowing for growth and removing parasites.
                </RaitingListItem>
              </RaitingList>
            </RaitingWrapper>
            <SnakeBtnBlock>
