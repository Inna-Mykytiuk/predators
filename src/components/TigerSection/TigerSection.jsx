            ...
            <TextWrapper isVisible={!isOpen}>
              ...
              <RaitingWrapper>
                ...
                <RaitingList isVisible={isOpen}>
                  ...
                  <RaitingListItem>
                    Tigers are territorial animals, marking their boundaries
                    with scent markings and scratches.
                  </RaitingListItem>
                  <RaitingListItem>
                    The tiger population has faced significant threats,
                    primarily due to habitat loss and poaching for their body
                    parts.
                  </RaitingListItem>
                </RaitingList>
              </RaitingWrapper>
