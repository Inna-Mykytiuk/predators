          ...
          <TextWrapper>
            ...
            <RaitingWrapper>
              ...
              <RaitingList isVisible={isOpen}>
                <RaitingListItem>
                  Sharks are a diverse group of marine predators, boasting over
                  500 species with varied sizes, shapes, and behaviors.
                </RaitingListItem>
                <RaitingListItem>
                ...
                <RaitingListItem>
                  ...
                  for their extensive migrations, covering thousands of miles in
                  open ocean.
                </RaitingListItem>
                <RaitingListItem>
                ...
                <RaitingListItem>
                  Sharks boast a prehistoric lineage, predating the existence of
                  dinosaurs by hundreds of millions of years.
                </RaitingListItem>
                <RaitingListItem>
                  The decline in shark populations poses significant threats to
                  marine ecosystems, underscoring the urgency of conservation
                  efforts.
                </RaitingListItem>
              </RaitingList>
            </RaitingWrapper>
