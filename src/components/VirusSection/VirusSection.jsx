      ...
      <VirusWrapper>
        <Container>
          <TextWrapper>
            ...
            <HeroTextSecondary>
              Delve into the unseen realm of microscopic menaces, where viruses
              and bacteria shape the course of life, challenging our
            ...
            <RaitingWrapper>
              ...
              <RaitingList isVisible={isOpen}>
                <RaitingListItem>
                  Viruses are not classified as living organisms but consist of
                ...
                <RaitingListItem>
                  ...
                  contributing to the microbiome and immune system development.
                </RaitingListItem>
                <RaitingListItem>
                  Bacteria can exchange genetic material through horizontal gene
                  transfer, contributing to their adaptability.
                </RaitingListItem>
                <RaitingListItem>
                ...
                <RaitingListItem>
                  The study of viruses and bacteria is essential in fields such
                  as medicine, biotechnology, and environmental science. scales.
                </RaitingListItem>
              </RaitingList>
            </RaitingWrapper>
            <VirusBtnBlock>
